...
const LoginPage = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (err.response && err.response.status >= 400) toast.error('Неправильный логин или пароль. Попробуйте ещё раз.')
    ...
    return (
        <Container maxWidth='xs'>
            ...
            >
                ...
                >
                    <Typography variant='h4' sx={{ marginBottom: 2, textAlign: 'center' }}>Вход</Typography>
                    <TextField
                        label="Email"
                        fullWidth
                        variant="outlined"
